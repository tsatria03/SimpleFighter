...
###### new in 6.0
* Changed the falling logic. Instead of making your character sit after hard landing on a platform, it will now stun them for a random duration of 1 to 2 seconds before making them be able to move again.
...
Thanks goes to Nikita K for the huge help with Optimizing the code in various areas of the game and writing some extra map functions for me, especially in the builder menu.
