...
- Any help topic that lists builder entities by category — notably the object index in `sf/docks/builder/maps.txt` (grouped Audio, Construction, Interaction, Kombat, Misc, Transition, Trap, Transportation, Zone), and any other topic that cross-references a set of entities.
