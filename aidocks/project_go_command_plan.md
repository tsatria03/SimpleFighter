...
**FEATURE COMPLETE (all 6 sections built & shipping 15.0, 2026-09).** /go moves any of 16 single-point types by keyword (newest) + carries riders both directions. DEFERRED FOLLOW-UP still open: broader carry_transport() from axis commands + combat knockback (see "Still OPEN" above). Drop this plan from the active backlog once 15.0 releases.
