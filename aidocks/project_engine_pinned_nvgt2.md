...
description: "SimpleFighter runs on the pinned legacy NVGT fork at C:\\nvgt2 (BASS); the newer C:\\nvgt (miniaudio) is only for testing others' games — don't suggest upgrading"
metadata: 
  node_type: memory
  type: project
