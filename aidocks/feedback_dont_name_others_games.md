...
**Why:** the dev is fine attributing to their own work, but doesn't want another creator's game named in their committed files. It came up porting a builder feature from an external reference game — the design is worth keeping, the source game's name is not.
