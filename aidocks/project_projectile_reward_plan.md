...
- **§6 — Docs (projectiles.txt) + 15.0 changelog entry. [DONE 2026-09]** projectiles.txt: Level + XP field entries (after Health), reward note on the Destroyable checkbox, zone-reward note, and the hand-authoring on-disk format updated (`…direction health level xp attack speed…`). 15.0 changelog entry added (top). All lines <1024. **FEATURE COMPLETE (§1-§6).**
